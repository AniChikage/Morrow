...
const api: DesktopAPI = {
  ...
  getUpgrade: () => ipcRenderer.invoke('morrow:get-upgrade'),
  ...
  respondNativeRequest: (id, requestId, response) =>
    ipcRenderer.invoke('morrow:respond-native-request', id, requestId, response),
